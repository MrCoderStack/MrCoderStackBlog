...
@section('title'){{setting('web_name', 'MrCoder技术栈').'|'.$cateName}}@endsection
@section('keywords'){{setting('web_name', 'MrCoder技术栈').','.$cateName}}@endsection
@section('description'){{setting('web_name', 'MrCoder技术栈').','.$cateName}}@endsection
@section('content')
    @parent
