...
@section('title'){{setting('web_name', 'MrCoder技术栈').'|'.'分类'}}@endsection
@section('keywords'){{setting('web_name', 'MrCoder技术栈').',分类列表'}}@endsection
@section('description'){{setting('web_name', 'MrCoder技术栈').',分类描述'}}@endsection
@section('content')
    @parent
